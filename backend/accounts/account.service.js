...
async function register(params, origin) {
    ...
    account.role = params.role == 'Admin' ? Role.Admin : params.role == 'User' ? Role.User : Role.Manager;
...
async function getAll() {
    console.log("Inside acc service")
...
function basicDetails(account) {
    const { id, title, name, email, role, created, updated } = account;
    return { id, title, name, email, role, created, updated };
}
